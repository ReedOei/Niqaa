...
gatlingGun = Part.makeGun 30 8 $ Part.Gun
    {
        Part.prec = 6,
        Part.timerGoal = 0.15,
        Part.timer = 0,
...
howitzer = Part.makeGun 35 6 $ Part.Gun
    {
        Part.prec = 2,
        Part.timerGoal = 8,
        Part.timer = 0,
...
broadSide = Part.makeGun 20 8 $ Part.Gun
    {
        Part.prec = 5,
        Part.timerGoal = 10,
        Part.timer = 0,
...
machineGun = Part.makeGun 35 20 $ Part.Gun
    {
...
megaLaser = Part.makeGun 3 15 $ Part.Gun
    {
        Part.prec = 1,
        Part.timerGoal = 0.05,
        Part.timer = 0,
...
bigBullet = Part.makeGun 50 25 $ Part.Gun
    {
        Part.prec = 30,
        Part.timerGoal = 10,
        Part.timer = 0,
...
slingShot = Part.makeGun 1 1 $ Part.Gun
    {
        Part.prec = 25,
        Part.timerGoal = 3,
        Part.timer = 0,
